...
def main(data_name):
    ...
    train_data = []
    with open(os.path.join(args.data_path, "train.txt"), "r", encoding='utf-8') as file:
        for line in file:
    ...
    dev_data = []
    with open(os.path.join(args.data_path, "dev.txt"), "r", encoding='utf-8') as file:
        for line in file:
            data1 = json.loads(line)
            dev_data.append(data1)
